    ...
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200/50 dark:border-zinc-800/40 bg-white/65 dark:bg-zinc-950/65 backdrop-blur-lg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group cursor-pointer">
          <div className="p-2 rounded-xl bg-gradient-to-tr from-primary-indigo to-primary-purple text-white shadow-md shadow-indigo-500/20 group-hover:scale-102 transition duration-200">
            <DownloadCloud className="w-5 h-5" />
          </div>
          <span className="text-md font-black tracking-tight bg-gradient-to-r from-zinc-900 to-zinc-600 dark:from-zinc-50 dark:to-zinc-400 bg-clip-text text-transparent">
            VELOCE
          </span>
